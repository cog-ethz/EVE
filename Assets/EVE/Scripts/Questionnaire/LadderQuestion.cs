...
public class LadderQuestion : Question
{
    private const int QuestionType = 6;

    private int _temporaryIntAnswer = -1;

    public LadderQuestion(string questionName, string text, int[] vals, string[] labels, string questionSetName, LoggingManager log)
    {
