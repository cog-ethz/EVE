...
public class Questionnaire : MonoBehaviour, IQuestionVisitor
{
    private LoggingManager _log;
    private MenuManager _menuManager;

    private Assets.EVE.Scripts.Questionnaire2.Questionnaire _questionnaire;
    private List<Assets.EVE.Scripts.Questionnaire2.QuestionSet> _questionSets;
    private Assets.EVE.Scripts.Questionnaire2.QuestionSet _currentQuestionSet;
    private Assets.EVE.Scripts.Questionnaire2.Questions.Question _question;
    ...
    void Awake()
    {
        ...
        var qf = new Assets.EVE.Scripts.Questionnaire2.QuestionnaireFactory(_log,launchManager.ExperimentSettings);
        ...
        _log.InsertLiveSystemEvent("Questionnaire", "Start Questionnaire", null, _questionnaire.Name);
    ...
    private void LoadQuestionSetAt(int index)
    {
        ...
        _log.insertLiveMeasurement("Questionnaire", "Start Set", null, name);
    ...
    public void GoBackOneQuestion()
    {
        ...
        _showedQuestions--;
        if (qOld.GetType() != typeof(InfoScreenQuestion))
        {
    ...
    {        
        ...
        if (_question.IsAnswered())
        {
            ...
            if (_question.GetType() == typeof(InfoScreenQuestion)) return;
    ...
    public void Visit(Assets.EVE.Scripts.Questionnaire2.Questions.Question q)
    {
    ...
    public void Visit(ChoiceQuestion q)
    {
        ...
        var isMultiple = q.Choice == Assets.EVE.Scripts.Questionnaire2.Enums.Choice.Multiple;
    ...
    public void Visit(Assets.EVE.Scripts.Questionnaire2.Questions.TextQuestion q)
    {
        var answernumber = 0;
        if (q.NRows == 1)
        {
    ...
    public void Visit(Assets.EVE.Scripts.Questionnaire2.Questions.LadderQuestion q)
    {
